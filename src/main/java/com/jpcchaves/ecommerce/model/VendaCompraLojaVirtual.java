...
@SequenceGenerator(
    name = "seq_venda_compra_loja_virtual",
    sequenceName = "seq_venda_compra_loja_virtual",
    allocationSize = 1)
public class VendaCompraLojaVirtual implements Serializable {

  private static final long serialVersionUID = 1117579829294362210L;

  @Id
  @GeneratedValue(
      strategy = GenerationType.SEQUENCE,
      generator = "seq_venda_compra_loja_virtual")
  private Long id;
  ...
  @ManyToOne
  @JoinColumn(
      name = "cup_desconto_id",
      foreignKey =
          @ForeignKey(
              value = ConstraintMode.CONSTRAINT,
              name = "cup_desconto_fk"))
